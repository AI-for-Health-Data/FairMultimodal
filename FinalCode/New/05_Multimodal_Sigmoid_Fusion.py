...
# Age bucketing and demographic mapping functions.
...
# BEHRT Model for Demographics (Structured Data Branch).
...
# Multimodal Transformer Model (Predicts Mortality, LOS, and Mechanical Ventilation).
class MultimodalTransformer(nn.Module):
    def __init__(self, text_embed_size, behrt_demo, behrt_lab, device, hidden_size=512):
        ...
        # Final classifier now outputs three logits.
...
def train_pipeline():
    ...
    # Process Structured Data: Demographics.
    ...
    # Lab Features: Exclude certain columns and note columns.
    ...
    # Multimodal Transformer Model predicting 3 outcomes.
    class MultimodalTransformer(nn.Module):
        def __init__(self, text_embed_size, behrt_demo, behrt_lab, device, hidden_size=512):
            super(MultimodalTransformer, self).__init__()
            self.behrt_demo = behrt_demo

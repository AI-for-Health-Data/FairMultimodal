...
# For LOS prediction (> 7 days), use a threshold of 168 hours.
df_struct['los_binary'] = (df_struct['icu_los'] > 168).astype(int)
...
# If 'los_binary' is not present, compute it (using 168 hours as threshold for 7 days).
if 'los_binary' not in structured_df.columns:
    structured_df['los_binary'] = (structured_df['icu_los'] > 168).astype(int)
